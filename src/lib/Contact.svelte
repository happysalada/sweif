    ...
    <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
      <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-300">
          Aclara tus dudas y preguntas directo con nuestro correo de contacto. En breve una personas de nuestro equipo se pondrá en contacto contigo.
        </p>
          ...
          <div>
            ...
            <div class="mt-2.5">
              <input
                ...
                class="block w-full rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div>
