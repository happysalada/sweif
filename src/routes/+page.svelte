...
<MetaTags title="Sweif - App de envío de dinero internacional" description="Transferencias Internacionales a España, Transparentes y con el Costo más Bajo Garantizado. Transferencias Económicas. Envía Dinero Online." />
  ...
  <div class="relative isolate pt-14">
    ...
    >
      <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
        ...
        >
          Nuestros giros internacionales son rápidos, seguros y sin costos ocultos.
        </h1>
    ...
    >
      <div class="px-6 lg:px-0 lg:pr-4 lg:pt-4">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
          ...
          >
            Envíos de dinero internacional
          </h2>
          <h3 class="mt-6 text-lg leading-8 text-gray-600">
            En solo dos pasos puedes y sin costos ocultos
          </h3>
          <dl
          ...
          >
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                ...
                <h3>Envía dinero a estudiantes en España</h3>
              </dt>
              <dd class="inline">
              </dd>
            </div>
            ...
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                ...
                <h3>Mueve dinero entre tus propias cuentas</h3>
              </dt>
              <dd class="inline">
              </dd>
            </div>
            ...
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                ...
                <h3>Paga a tus trabajadores en España</h3>
              </dt>
              <dd class="inline">
              </dd>
            </div>
            ...
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                ...
                <h3>Resguarda tu dinero en dolares o euros digitales</h3>
              </dt>
              <dd class="inline">
              </dd>
            </div>
...
<Contact contactForm={data.contactForm}/>
