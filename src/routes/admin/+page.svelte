<div class="p-12">
  <div>
    ...
    <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-4">
      <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
        <dt class="truncate text-sm font-medium text-gray-500">USDC</dt>
      ...
      <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
        <dt class="truncate text-sm font-medium text-gray-500">USDT</dt>
        <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
          5816
        </dd>
      </div>
      ...
      <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
        <dt class="truncate text-sm font-medium text-gray-500">COP</dt>
        <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
          2,457,653
        </dd>
      </div>
      ...
      <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
        <dt class="truncate text-sm font-medium text-gray-500">EURC</dt>
        <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
          2,457,653
        </dd>
      </div>
  ...
  <div class="mt-12">
    ...
    >
      <li class="col-span-1 flex rounded-md shadow-sm">
        ...
        >
          <div class="flex-1 truncate px-4 py-2 text-sm">
            <a
              href="/admin/deposits"
              class="font-medium text-gray-900 hover:text-gray-600">Deposits</a
            >
            <p class="text-gray-500">120</p>
          </div>
          <div class="flex-shrink-0 pr-2">
      ...
      <li class="col-span-1 flex rounded-md shadow-sm">
        <div
          class="flex w-16 flex-shrink-0 items-center justify-center bg-blue-500 rounded-l-md text-sm font-medium text-white"
        >
          C
        </div>
        <div
